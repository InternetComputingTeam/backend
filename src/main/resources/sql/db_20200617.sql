...
CREATE TABLE `time` (
  ...
  `create_time` varchar(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `avatar_url` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2020-06-17 21:40:25
